...
const APP_SHELL = [
  ...
  "./index.html",
  "./offline.html",
  "./manifest.webmanifest?v=td-r70-v1",
  "./sw.js",
  "./assets/cover.png",
  "./src/config.js?v=td-r70-v1",
  "./src/heroes.js?v=td-r70-v1",
  "./src/rules.js?v=td-r70-v1",
  "./src/lore.js?v=td-r70-v1",
  "./src/enemy-animation.js?v=td-r70-v1",
  "./src/hero-animation.js?v=td-r70-v1",
  "./src/game.js?v=td-r70-v1",
  "./src/ui.js?v=td-r70-v1",
